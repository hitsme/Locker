package com.hitsme.locker.app.sample.patternlock;
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR =
                new Creator<SavedState>() {
                    @Override
                    public PatternView.SavedState createFromParcel(Parcel in) {
                        return new PatternView.SavedState(in);
                    }

                    @Override
                    public PatternView.SavedState[] newArray(int size) {
                        return new PatternView.SavedState[size];
                    }
                };
    }
