package com.hitsme.locker.app.migracion;

import android.content.Context;

import com.hitsme.locker.app.LockApplication;
import com.hitsme.locker.app.old.Core.Utils.FileUtils;
import com.hitsme.locker.app.old.Core.Utils.Utils;
...
public class MigrarUtilsDeprecated implements Serializable {
    ...
    public boolean esEncriptadoViejo() {
        try{
            ...
            String extension = com.hitsme.locker.app.core.utils.FileUtils.getExtensionFile(new File(fullpath).getName());
